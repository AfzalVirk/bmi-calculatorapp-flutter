...
const kBottomContainerColor = Color(0xFFE2232F);
const kActivecolor = Color(0xFF1F509A);
const kInactivecolor = Color(0xFF10366F);
...
const kTitleTextStyle =
    TextStyle(fontSize: 50.0, fontWeight: FontWeight.bold, color: kActivecolor);
